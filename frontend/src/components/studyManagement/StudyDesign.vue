...
The currently selected image-set will be highlited green.">
            ...
            <div class="col-lg-10 h-100 mb-2">
                <div class="row w-100 mx-auto">
                    <button class="btn btn-dark mb-2" data-bs-toggle="collapse" data-bs-target="#imgset_creation"
                        aria-expanded="true" aria-controls="imgset_creation">
                        <h4 class="mt-1">Image Sets &#9776;</h4>
                    </button>
                </div>
                <!-- Create Image Sets -->
                <div id="imgset_creation"
                    class=" collapse show row mx-auto my-auto">
                    ...
                    <div id="imgset" class="w-100">
                        ...
                        <div id="ref_images">
                            ...
                            <div id="comp_images">
                                ...
                                <div class="row justify-content-center mx-auto" id="dicom_row_">
                                </div>
                            </div>
                            <!-- modify buttons -->
                            <div id="imgset_buttons">
                                <div class="row mt-3 mb-2">
                                    <div class="col-lg-12 text-center">
                                        <input type="button" value="append imgset"
                                            class="imgset_btn btn-success btn col-lg-2" id="add_imgset"
                                            title="add image-set to the end of the study">
                                        <input type="button" value="insert imgset"
                                            class="imgset_btn btn-success btn col-lg-2" id="insert_imgset"
                                            title="inserts image-set at the currently selected position">
                                        <input type="button" value="update imgset"
                                            class="imgset_btn btn-light btn col-lg-2" id="upd_imgset"
                                            title="update currently selected image-set">
                                        <input type="button" value="delete imgset"
                                            class="imgset_btn btn-danger btn col-lg-2" id="del_imgset"
                                            title="delete currently selected image-set">
                                        <input type="button" value="delete all imgsets"
                                            class="imgset_btn btn-danger btn col-lg-2" id="del_all_imgsets">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-2">
                ...
                <div class="row mx-auto">
                    <button class="btn btn-dark col-12 mb-1" data-bs-toggle="collapse" data-bs-target="#design_settings"
          ...
          " aria-expanded="true" aria-controls="design_settings">
                ...
                <div id="design_settings" class="collapse show">
                    ...
                    <div class="row mx-auto mt-1" >
                        <button class="btn-secondary btn col-12" data-bs-toggle="collapse"
                            data-bs-target="#general_settings" aria-expanded="true" aria-controls="general_settings"
                    ...
                    <div id="general_settings" class="collapse">
                        <div class="mx-auto">
                            <div class="input-group row mx-auto" title="Controls max number of reference images">
                            ...
                            <div class="input-group row mx-auto" title="Controls the number of images (m-AFC tests)">
                                <div class="input-group-prepend col-6 px-0 mx-0">
                            ...
                            <div class="input-group row mx-auto" title="Controls the number of annotations (e.g. rois)
...
Set to 0 to allow any number.">
                            ...
                            <div class="row mx-auto">
                                <div class="input-group"
                                    ...
                                    <input id="img_width" type="Number" step="any" class="image_size form-control"
                                        placeholder="width">
                                    <input id="img_height" type="Number" step="any" class="image_size form-control"
                                        placeholder="height">
                                </div>
                            </div>
                            ...
                            <div class="input-group row mx-auto">
                                ...
                                <input class="form-control" type="text" id="text_color"
                                    placeholder="Text-Color (Hex or Name)" value="">
                            </div>
                            ...
                            <div class="input-group row mx-auto"
                                ...
                                <input class="form-control" type="number" min="0" name="instructions"
                                    id="transition_time" placeholder="sec" value="">
                            </div>
                            ...
                            <div class="row input-group mx-auto"
                                ...
                                <input class="form-control" type="text" name="buttonLabels" id="button_labels"
                    ...
                    <!-- tool settings -->
                    <div class="row mx-auto mt-1">
                        <button class="btn-secondary btn col-12" data-bs-toggle="collapse" data-bs-target="#tools"
                            aria-expanded="true" aria-controls="tools" title="Tools define DICOM viewer and annotation tools that are made available to participants
(e.g., scrolling, windowing, rectangular, elliptical or free-hand ROIs).">
                    ...
                    <div class="row mx-auto mt-1"
                        ...
                        <!-- instructions -->
                        <button class="btn-secondary btn col-12" data-bs-toggle="collapse"
                            data-bs-target="#instructions_container" aria-expanded="true"
                        ...
                        <div id="instructions_container" class="w-100 collapse">
                            <div class="input-group" id="instructions_input_field">
                                <textarea rows="3" class="form-control " type="text" name="instructions"
                                    id="instructions" placeholder="Instructions"></textarea>
                            </div>
                            <div id="instructions_user_view" style="white-space: pre-wrap;">
                            </div>
                        </div>
                    ...
                    <div class="row mx-auto mt-1"
                        ...
                        <button class="btn btn-secondary col-12" data-bs-toggle="collapse"
                    ...
                    <div id="scales_container" class="collapse">
                        ...
                        <div id="scales" class="mt-1">
                            ...
                            <div id="scale_" class="mt-1 scale_template" style="display:none">
                                ...
                                <div class="mx-auto scale_view_admin"
                                    id="scale_view_admin_">
                                    <div class="row mx-auto scale_text_admin" id="scale_text_admin_">
                                        <div class="input-group">
                                            <div class="input-group-prepend col-4 px-0 mx-0">
                                                <span class="input-group-text col-12">Text</span>
                                            </div>
                                            <textarea id="scale_text_input_"
                                                class="form-control scale_text_input"></textarea>
                                        </div>
                                    </div>
                                    <div class="row mx-auto scale_min_admin" id="scale_min_admin_">
                                        <div class="input-group">
                                            <div class="input-group-prepend col-4 px-0 mx-0">
                                                <span class="input-group-text col-12">Start</span>
                                            </div>
                                            <input class="form-control scale_min_input" min="-100" max="100"
                                                type="number" id="scale_min_input_" placeholder="min"
                                                value="">
                                        </div>
                                    </div>
                                    <div class="row mx-auto scale_max_admin" id="scale_max_admin_">
                                        <div class="input-group">
                                            <div class="input-group-prepend col-4 px-0 mx-0">
                                                <span class="input-group-text col-12">End</span>
                                            </div>
                                            <input class="form-control scale_max_input" min="-100" max="100"
                                                type="number" id="scale_max_input_" placeholder="max"
                                                value="">
                                        </div>
                                    </div>
                                    <div class="row mx-auto scale_type_admin" id="scale_type_admin_" title="Can be left blank for most studies except for FROC designs,
where a scale needs to be repeated each time a new roi is drawn.">
                                        <div class="input-group">
                                            ...
                                            <select id="scale_type_input_" class="custom-select scale_type_input">
                                                <option value=""></option>
                                                <option value=''></option>
                                            </select>
                                        </div>
                                    </div>
                                    <button class="btn btn-danger btn-block scale_rm" id="scale_rm_">rm
                                        scale</button>
                                </div>
                                <!-- participant view of scale -->
                                <div class="mx-auto mb-3 scale_view_user" id="scale_view_user_">
                                    <div class="row mx-auto justify-content-center">
                                        <div id="scale_text_" class="col scale_text"
                                            style="white-space: pre-wrap; text-align: center;">
                                        </div>
                                    </div>
                                    <div class="row mx-auto justify-content-center mt-1 scale_values" id="scale_values_"
                                        style="display:none;">
                                    </div>
                                </div>
                            </div>
                    ...
                    <form method="post">
                        <div class="form-group">
                            <input class="btn btn-light btn-lg btn-block mt-1 w-100" type=button id="submit_design"
                                value="Save Design">
                        </div>
                    </form>
                </div>
...
To globally control viewport settings use the defaults submenu.">
                    <div class="row mt-1 mx-auto">
                        <button class="btn btn-dark col-12 mb-2" data-bs-toggle="collapse"
                    ...
                    <div id="viewport_def" class="collapse ">
                        ...
                        <div class="row mx-auto">
                            <div class="input-group">
                                ...
                                <input id="def_ww" type="Number" step="any" min="0"
                                    class="form-control def_ww viewport_prop_def" placeholder="WW">
                                <input id="def_wc" type="Number" step="any" min="0"
                                    class="form-control def_wc viewport_prop_def" placeholder="WC">
                            </div>
                        </div>
                        <!-- zoom -->
                        <div class="row mx-auto">
                            <div class="input-group">
                                ...
                                <input id="def_zoom" type="Number" step="any" min="0.0"
                                    class="form-control def_zoom viewport_prop_def" placeholder="Zoom">
                            </div>
                        </div>
                        <!-- position -->
                        <div class="row mx-auto">
                            <div class="input-group">
                                ...
                                <input id="def_pos_x" type="Number" step="any"
                                    class="form-control def_pos_x viewport_prop_def" placeholder="x">
                                <input id="def_pos_y" type="Number" step="any"
                                    class="form-control def_pos_y viewport_prop_def" placeholder="y">
                            </div>
                        </div>
                        <div class="row mx-auto">
                            <!-- position -->
                            <button id=update_viewports class="btn btn-light col-12">update existing
                                image-sets</button>
                        </div>
                    </div>
                        ...
                        <div id="viewports_man_container">
                            <div id="viewports_auto_container">
                                <div id="viewport_info_">
                                    <div class="row mx-auto mt-1">
                                        <button class="btn btn-secondary col-12" data-bs-toggle="collapse"
                                            data-bs-target="#viewport_" aria-expanded="true" aria-controls="viewport_">
                                    ...
                                    <div id="viewport_" class="collapse">
                                        ...
                                        <div class="row mx-auto">
                                            <div class="input-group">
                                                ...
                                                <input id="ww_" type="Number" step="any" min="0"
                                                    class="form-control ww viewport_prop" placeholder="WW">
                                                <input id="wc_" type="Number" step="any"
                                                    class="form-control wc viewport_prop" placeholder="WC">
                                            </div>
                                        </div>
                                        <!-- window zoom -->
                                        <div class="row mx-auto">
                                            <div class="input-group">
                                                ...
                                                <input id="zoom_" type="Number" step="any" min="0.0"
                                                    class="form-control zoom viewport_prop" placeholder="Zoom">
                                            </div>
                                        </div>
                                        <!-- window position -->
                                        <div class="row mx-auto">
                                            <div class="input-group">
                                                ...
                                                <input id="pos_x_" type="Number" step="any"
                                                    class="form-control pos_x viewport_prop" placeholder="x">
                                                <input id="pos_y_" type="Number" step="any"
                                                    class="form-control pos_y viewport_prop" placeholder="y">
                                            </div>
                                        </div>
                                        <!--reset buttons -->
                                        <button id=reset_ class="btn btn-block btn-light reset">reset</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
ROIs can be drawn on images to define the ground truth in LROC and FROC studies.">
                    <div class="row mx-auto roi_input">
                        <button class="btn btn-dark col-12 mb-1" data-bs-toggle="collapse"
                            data-bs-target="#roi_settings" aria-expanded="true" aria-controls="roi_settings">
                    ...
                    <div id="roi_settings" class="collapse mb-3 show roi_input">
                        ...
                        <div id="roi_info_img_" class="mt-1 ref_rois">
                            <span class="badge-secondary badge col-12">
                                <button class="btn btn-secondary btn-block" data-bs-toggle="collapse"
                                    data-bs-target="#rois_img_" aria-expanded="true" aria-controls="rois_img_">
                                    <h5 class="col-12 mt-1">ROIs</h5>
                                </button>
                                <div id="rois_img_" class="collapse">
                                    <div class="row text-center mx-auto">
                                        <button id=import_ann_ class="btn btn-block btn-success import_ann col">Import
                                            Rois
                                            From</button>
                                    </div>
                                    <div class="row text-center mx-auto">
                                        <div class="input-group">
                                            ...
                                            <input id="import_ann_is_" type="Number" min="1" class="form-control  col"
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="row text-center mx-auto">
                                        <div class="input-group">
                                            <div class="input-group-prepend col-6 px-0 mx-0">
                                                <span class="input-group-text col-12">Image-Position</span>
                                            </div>
                                            <input id="import_ann_ip_" type="Number" min="1" class="form-control  col"
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="row text-center mx-auto">
                                        <div class="input-group">
                                            <div class="input-group-prepend col-6 px-0 mx-0">
                                                <span class="input-group-text col-12">Stack-Position</span>
                                            </div>
                                            <input id="import_ann_sp_" type="Number" min="1" class="form-control  col"
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="row text-center mx-auto">
                ...
                <!--Segmentations-->
                <div id="seg_settings_container" class="w-100 mb-1" style="display: none;" title="">
                    <div class="row mx-auto roi_input">
                        <button class="btn btn-dark col-12 mb-1" data-bs-toggle="collapse"
                            data-bs-target="#seg_settings" aria-expanded="true" aria-controls="seg_settings">
                        ...
                        <div class="mt-1">
                            <div class="row text-center mx-auto">
                                <div class="input-group">
                                    ...
                                    <input type="Number" min="1" class="form-control col" value="10" id="brush_size">
                                </div>
                            </div>
                            <div class="row text-center mx-auto">
                                <div class="input-group">
                                    ...
                                    <input type="Number" min="1" class="form-control col" value="1" id="seg_label">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="results_container" class="w-100 mb-1" style="display: none;"
                    title="Load results from a study where annotation data was collected e.g. ROIs.">
                    <div class="row mx-auto roi_input">
                        <button class="btn btn-dark col-12 mb-1" data-bs-toggle="collapse" data-bs-target="#results"
