...
The currently selected image-set will be highlited green.">
            ...
            <div class="col-lg-10 h-100 mb-2">
                ...
                <!-- Create Image Sets -->
                <div id="imgset_creation" class=" collapse show row mx-auto my-auto">
                        ...
                        <div id="imgset_buttons">
                            <div class="row mt-3 mb-2">
                                <div class="col-lg-12 text-center">
                                    ...
                                    <input type="button" value="update imgset" class="imgset_btn btn-light btn col-lg-2"
                                        id="upd_imgset" title="update currently selected image-set">
...
Set to 0 to allow any number.">
                        ...
                        <div class="input-group row mx-auto">
                            ...
                            <input class="form-control" type="text" id="background_color"
                                placeholder="Background-Color (Hex or Name)" value="">
                        </div>
                                ...
                                <div class="row mx-auto scale_min_admin" id="scale_min_admin_">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control scale_min_input" min="-100" max="100" type="number"
                                            id="scale_min_input_" placeholder="min" value="">
                                    </div>
                                </div>
                                <div class="row mx-auto scale_max_admin" id="scale_max_admin_">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control scale_max_input" min="-100" max="100" type="number"
                                            id="scale_max_input_" placeholder="max" value="">
                                    </div>
                                </div>
...
ROIs can be drawn on images to define the ground truth in LROC and FROC studies.">
            ...
            <div id="seg_settings_container" class="w-100 mb-1" style="display: none;" title="">
                <div class="row mx-auto roi_input">
                    <button class="btn btn-dark col-12 mb-1" data-bs-toggle="collapse" data-bs-target="#seg_settings"
                        aria-expanded="true" aria-controls="seg_settings">
