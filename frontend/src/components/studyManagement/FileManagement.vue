<template>
    <div class="container mt-4">
        <div class="row h-100">
            <div class="col-12">
                <div class="row">
                    <button type="button" class="btn btn-secondary btn-block mt-1" data-bs-toggle="collapse"
                        data-bs-target="#naming" aria-expanded="false" aria-controls="naming">
                        <h5 class="col-12 mt-1">Rules and Naming conventions &#9776;</h5>
                    </button>
                ...
                <div class="row">
                    <button class="btn btn-secondary btn-block mt-1" type="button" data-bs-toggle="collapse"
                        data-bs-target="#uploaded_files" aria-expanded="false" aria-controls="uploaded_files">
                ...
                <div class="row mb-4">
                    <button class="btn btn-secondary btn-block mt-1" type="button" data-bs-toggle="collapse"
                        data-bs-target="#files_upload" aria-expanded="false" aria-controls="files_upload">
                    ...
                    <div id="files_upload" class="collapse show bg-light">
                        ...
                        <div class="row mx-auto">
                            <div class="custom-file mx-auto col-6">
                                <input type="file" name="file" class="custom-file-input form-control w-100" id="file" multiple />
                            </div>
                            <input id="upload_files" class="btn-success btn btn-block col-6" type="button"
                                value="Upload Files">
                        </div>
                    </div>
                </div>
