      ...
      <div id="imgset_settings" class="show accordion-collapse accordion">
        ...
        <div class="accordion-item mb-1">
          <div class="row">
            <div class="col-2 my-auto mx-auto">
              <button class="btn btn-secondary btn-lg" data-bs-toggle="popover" :data-bs-title="this.popoverTitle"
                :data-bs-content="this.popoverTextMan" data-bs-placement="left">&#9432;
              </button>
            </div>
          ...
          <div class="collapse accordion-collapse show" id="images_create_man">
            <div>
              <div v-if="imgsets.length > 0" class="input-group mx-auto" data-toggle="tooltip" data-placement="left" title="">
              ...
              <div class="row mx-auto">
                  <button class="text-start btn input-group-text bg-gray-300 mt-1" data-bs-toggle="collapse" data-bs-target="#images_displayed"
              ...
              <!-- viewport settings -->
              <div id="viewport_settings_container" class="w-100 mt-1" title="Image Viewer settings control display options (zoom, position, window) for the uploaded study images. Each viewport can be controlled individually.">
                <div class="row mx-auto">
                  <button class="text-start btn btn-grey input-group-text bg-gray-300" data-bs-toggle="collapse" data-bs-target="#viewport_settings"
              ...
              <div class="row mt-1">
                <div class="input-group">
                  ...
                  <input class="form-control" type="Number" min="1" :max="imgsets.length + 1" step="1" id="numb_refimg"
                    v-model="imagesetAddPosition" />
                </div>
              </div>
              ...
              <div v-if="imgsets.length" class="row mx-auto">
                <button class="text-start btn-danger btn" @click="deleteAllImgsets">Delete all Image-Sets
                </button>
              </div>
            </div>
          </div>
        ...
        <div class="accordion-item">
          <div class="row">
            <div class="col-2 my-auto mx-auto">
              <button class="btn btn-secondary btn-lg" data-bs-toggle="popover" :data-bs-title="this.popoverTitle"
                :data-bs-content="this.popoverTextAuto" data-bs-placement="left">&#9432;
              </button>
            </div>
          ...
          <div id="images_create_auto" class="collapse">
            ...
            <div v-if="afcCreateAuto" class="input-group w-100">
              ...
              <!-- viewport settings -->
              <div id="viewport_settings_container_auto" class="w-100 mt-1" title="Image Viewer settings control display options (zoom, position, window) for the uploaded study images. Each viewport can be controlled individually.">
                <div class="row mx-auto">
                  <button class="text-start btn btn-grey input-group-text bg-gray-300" data-bs-toggle="collapse" data-bs-target="#viewport_settings_auto"
                    aria-expanded="true" aria-controls="viewport_settings_auto">
                    <div class="mr-auto" id="imgset_btn">Viewer Settings</div>
                  </button>
                </div>
            ...
            <div class="mt-1">
              <button @click="createImgsetsAuto" class="w-100 btn btn-success imgset_btn" value="generate imgsets"
                id="btn_auto_imgset">
                Create Image-Sets
              </button>
            </div>
...
export default {
  ...
  data () {
    return {
      ...
      popoverText: 'This section controls the images displayed to users during a study. Image-Sets can be created manually (one by one) using the "Images displayed" select menu and the Manual-Creation buttons. To automatically add all uploaded images to image-sets use the Auto-Creation Menu. Settings such as image position, windowing and zoom level can be controlled via the Viewer Settings Menus.',
      popoverTextMan: '',
      popoverTextAuto: ''
    }
  },
